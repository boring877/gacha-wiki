...
async function sendUpdateFromFile(filePath, webhookUrl) {
  try {
    ...
    const { sendDiscordNotification, validateUpdateData } = await import('../src/utils/discord-webhook.js');
...
async function main() {
  ...
  console.log('  bun run scripts/send-discord-update.js --file src/data/zone-nova/updates/maintenance-july-8-2025.js');
}
