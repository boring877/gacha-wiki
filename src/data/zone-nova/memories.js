...
export const ZONE_NOVA_MEMORIES = [
  ...
  {
    id: 'afternoon-waiting',
    slug: 'afternoon-waiting',
    name: "Afternoon Waiting",
    image: 'https://pub-dd9a9c01bc7a43d0bb977b255815a5c4.r2.dev/zone-nova/memories/afternoon-waiting.png',
    rarity: 'SSR',
    element: null,
    character: "Brynhild",
    class: 'Warrior',
    detailUrl: '/guides/zone-nova/memories/afternoon-waiting/',
    stats: {
      hp: 6000,
      attack: 600,
      defense: 600,
    }, lv1Stats: { hp: 297, attack: 22, defense: 31 },
    story: "Afternoon sunlight streamed into the room through the window, casting a soft glow on the white walls and bed, making the space exceptionally bright. A gentle breeze stirred the curtains, scattering a few white feathers onto the bed, one of which slowly turned over with the wind. When you entered the room, Brynhild was resting on the bed. She had her elbows propped on the soft mattress, one hand supporting her chin, her usually upright posture unusually relaxed. Her long hair cascaded down her shoulders, a few feathers landing beside her, making the scene resemble a Valkyrie's brief, leisurely afternoon. Brynhild quickly noticed you, a smile playing on her lips. Her gaze naturally met yours, her eyes, usually so resolute and sharp on the battlefield, now less tense. Commander, you've come. She watched you approach the bedside, her fingers gently brushing aside a feather that had fallen in front of her. There are no more missions today, right? Then... stay with me for a while, okay? In the pristine white room, only the sunlight streaming through the window and the occasional fluttering feather remained. Compared to the Valkyrie leading everyone on the battlefield, Brynhild, now so close at hand, seemed to only want to offer you this precious time of rest.",
    effects: [  // awaken levels 1-5
