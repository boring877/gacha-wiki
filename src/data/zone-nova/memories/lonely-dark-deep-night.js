...
export const lonelyDarkDeepNightSEO = {
  ...
  description: 'Complete guide for Lonely Dark Deep Night memory card in Zone Nova. Learn about its kill stacking mechanics and critical damage synergy with Chiya builds.'
}; 
