...
export const heroesNeverStopData = {
  ...
  characterSynergy: {
    description:
      'This memory card transforms Shanna into an ultimate boss killer and single-target eliminator. It synergizes perfectly with her [Focus] stacking mechanism and critical hit damage bonuses from awakenings.',
    synergies: [
