...
export const secretRoomRealityData = {
  ...
  characterSynergy: {
    description:
      'This memory card transforms Tefnut into a continuous damage powerhouse by significantly increasing the penetration rate of her DOT effects. It synergizes perfectly with her [Holy Erosion] and [Light Erosion] debuffs.',
    synergies: [
