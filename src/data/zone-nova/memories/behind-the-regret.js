...
export const behindTheRegretData = {
  ...
  characterSynergy: {
    description:
      'This memory card transforms Mordred into an unstoppable HP-scaling tank by significantly boosting both her maximum HP and healing effectiveness. The 24% HP increase enhances all her HP-scaling abilities while the 30% healing boost amplifies her sustain.',
    synergies: [
