...
export const trueOrderData = {
  ...
  characterSynergy: {
    description:
      'This memory card transforms Loki into the ultimate debuff amplifier by significantly boosting his attack power and adding a vulnerability mark effect. The 24% increased damage mark synergizes perfectly with his passive vulnerability stacking.',
    synergies: [
