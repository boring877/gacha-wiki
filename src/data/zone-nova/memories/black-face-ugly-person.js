...
export const heraMemorySEO = {
  ...
  description: 'Complete guide for Hera Memory card in Zone Nova. Learn about its sustained damage synergy and chaos damage optimization with Hera builds.'
}; 
