...
export const sleepTreasureData = {
  ...
  characterSynergy: {
    description: 'This memory card transforms Zashiki-warashi into the ultimate team buffer by amplifying her already powerful ultimate ability. The guaranteed team damage boost combined with the chance for critical damage enhancement creates devastating team-wide damage spikes.',
    synergies: [
