...
export const battlefieldFlowerData = {
  ...
  characterSynergy: {
    description:
      'This memory card transforms Nini into a devastating damage dealer against debuffed enemies. It synergizes perfectly with her debuff application abilities and her passive that increases damage against enemies with negative effects.',
    synergies: [
