...
export const gaiamemoryData = {
  ...
  effects: {
    ...
    details: [
      ...
      },
      {
        ...
        description:
          'When the wearer has performed healing recently, their next healing is even more powerful',
      },
    ],
  ...
  usage: {
    optimal:
      'Best used on Gaia in healer role where she can consistently trigger the conditional healing boost',
    synergy: 'Combines excellently with team HP boost abilities and defensive compositions',
    timing:
      'The 1-second window for conditional healing requires active management but provides significant payoff',
  },
};
