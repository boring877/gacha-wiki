...
export const theBeautyOfHeijingCastleData = {
  ...
  characterSynergy: {
    description: 'This memory card transforms Snow Girl into both a healer and damage buffer, providing massive healing boosts and granting damage bonuses to fully healed allies. It synergizes perfectly with her sustained recovery effects.',
    synergies: [
