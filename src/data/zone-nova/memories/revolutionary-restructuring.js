...
export const revolutionaryRestructuringSEO = {
  ...
  description: 'Complete guide for Revolutionary Restructuring memory card in Zone Nova. Learn about its infiltration mechanics and chaos damage synergy with Cleopatra builds.'
}; 
