...
export const summerAfternoonNapTimeSEO = {
  ...
  description: 'Complete guide for Summer Afternoon Nap Time memory card in Zone Nova. Learn about its disaster-specific effects, attack scaling, and multi-enemy mechanics.'
}; 
