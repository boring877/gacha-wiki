...
export const sisterPennyTryingOnNewClothesSEO = {
  ...
  description:
    'Complete guide for Sister Penny Trying on New Clothes memory card in Zone Nova. Learn about its guardian-specific effects, HP bonuses, and defensive mechanics.',
};
