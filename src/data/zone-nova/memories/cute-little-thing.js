...
export const cuteLittleThingData = {
  ...
  characterSynergy: {
    description:
      "This memory card enhances Horus's debuffer role by significantly boosting his attack power and amplifying the damage from his continuous damage effects. The 24% damage amplification synergizes perfectly with his [Piercing] debuff stacks, making enemies take massive sustained damage.",
    synergies: [
