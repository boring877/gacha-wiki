...
export const pervertedLittleNurseData = {
  ...
  characterSynergy: {
    description:
      'This memory card transforms Leviathan into a critical hit powerhouse by providing massive critical rate boosts after her frequent pursuit attacks. The 36% critical rate increase synergizes perfectly with her mark-based pursuit system.',
    synergies: [
