...
export const solitaryRealmData = {
  ...
  characterSynergy: {
    description:
      'This memory card transforms Kela into the ultimate support healer by significantly boosting her healing output and providing crucial damage reduction. The protection effect stacks with her passive and awakening abilities for maximum survivability.',
    synergies: [
