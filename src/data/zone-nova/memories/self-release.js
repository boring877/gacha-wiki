...
export const selfReleaseData = {
  ...
  characterSynergy: {
    description:
      'This memory card transforms Lyra into the ultimate boss killer by dramatically boosting her ultimate damage. The scaling bonus for fewer enemies perfectly complements her passive that increases attack based on enemy count, creating optimal damage output in all scenarios.',
    synergies: [
