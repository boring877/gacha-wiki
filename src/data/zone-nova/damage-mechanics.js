...
export const damageMechanicsData = {
  meta: {
    ...
    description:
      "Complete guide to Zone Nova's damage calculation system, defense mechanics, and damage reduction formulas",
  ...
  defenseEquation: {
    ...
    coefficient: 972.95,
    description:
      'Zone Nova uses a coefficient-based defense system where higher defense provides diminishing returns',
  },

  coefficientExplanation: {
    value: 972.95,
    description:
      'When your defense equals the coefficient (972.95), you take exactly 50% damage. Higher defense gives diminishing returns.',
    examples: [
      {
        defense: 500,
        percentage: 66.07,
  ...
  damageReductionExamples: {
    ...
    enemyAttack: 1000,
    description:
      'Damage Reduction% is calculated last after getting the difference between attack and defense, making it quite powerful against bosses!',
    examples: [
      {
        damageReduction: 0,
        finalDamage: 500.0,
        ...
        calculation:
          '(1000 × 972.95) / (972.95 + 972.95) × (1 - 0%) = 972,950 / 1,945.9 × 1.0 = 500.0',
      },
      {
        damageReduction: 25,
        finalDamage: 375.0,
        ...
        calculation:
          '(1000 × 972.95) / (972.95 + 972.95) × (1 - 25%) = 972,950 / 1,945.9 × 0.75 = 375.0',
      },
      {
        damageReduction: 50,
        finalDamage: 250.0,
        ...
        calculation:
          '(1000 × 972.95) / (972.95 + 972.95) × (1 - 50%) = 972,950 / 1,945.9 × 0.5 = 250.0',
      },
      {
        damageReduction: 75,
        finalDamage: 125.0,
        ...
        calculation:
          '(1000 × 972.95) / (972.95 + 972.95) × (1 - 75%) = 972,950 / 1,945.9 × 0.25 = 125.0',
      },
    ],
  },
  ...
  mechanics: {
    ...
    damageReduction: {
      description:
        'Calculated last after getting the difference between attack and defense, making it quite powerful against bosses',
    },
  },
};
  ...
  gaia: {
    ...
    ultimateSkill: {
      ...
      calculateHPIncrease: (gaiaMaxHP, allyBaseHP) => {
        const increase = allyBaseHP * 0.6; // 60% of ally's base HP
    ...
    awakenings: {
      ...
      awakening6: {
        ...
        calculateTotalHPIncrease: (gaiaMaxHP, allyBaseHP) => {
          const baseIncrease = allyBaseHP * 0.6; // Base 60% increase
          const additionalIncrease = allyBaseHP * 0.5; // Additional 50% increase
...
export const gaiaCalculations = {
  ...
  calculateAllyFinalHP: (
    gaiaMaxHP,
    allyBaseHP,
    hasMotherlyLove = false,
    hasUltimate = false,
    hasAwakening6 = false
  ) => {
    let totalIncrease = 0;
    ...
    if (hasMotherlyLove) {
      ...
      if (hasAwakening6) {
        const additionalIncrease = Math.min(allyBaseHP * 0.5, cap - totalIncrease);
  ...
  calculateGaiaHealingOutput: (
    ...
    // Memory Card bonuses
    if (hasMemoryCard) {
      healingMultiplier += 0.4; // +40% base bonus
      if (recentlyHealed) {
        healingMultiplier += 0.4; // Additional +40% if recently healed
      }
    }
