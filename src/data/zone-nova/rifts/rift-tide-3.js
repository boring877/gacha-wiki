...
export const riftTide3Data = {
  ...
  fullDescription:
    'Block-focused rift with energy recovery and damage stacking mechanics. Team up using [Rift Laws] to defeat waves of enemies surging through dimensional tears.',
