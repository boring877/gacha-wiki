...
export const zashikiWarashiData = {
  ...
  skills: {
    ...
    auto: {
      ...
      description: 'All allied units gain 36% attack power. Attack power cap: Cannot exceed 36% of Zashiki-warashi\'s entry attack power. Maximum 1 layer, lasts 15 seconds'
    },
    ultimate: {
      name: 'Share Fortune! Share Hardship!',
      energyCost: '3', // e.g., '5'
      description: 'All allied units receive 36% damage increase for 15 seconds. Low Energy Cost: Only 3 energy allows frequent usage'
    },
    passive: {
      name: 'Child\'s Blessing',
      description: 'After releasing skill: The allied unit with highest attack power gains one layer [Blessing]. [Blessing] Effect: Increases attack power by 60% for 15 seconds'
    }
  },
  ...
  awakenings: [
    { level: 1, effect: 'Upon entering battle: All allied units gain 15% attack increase for 30 seconds' },
    { level: 2, effect: 'When using ultimate: Characters with [Blessing] additionally gain 15% damage increase' },
    { level: 3, effect: '[Skill] and [Normal Attack] level and level cap +4' },
    { level: 4, effect: 'After using skill: All allied units gain 10% critical rate for 5 seconds' },
    { level: 5, effect: '[Ultimate] and [Passive] level and level cap +4' },
    { level: 6, effect: 'When using ultimate: Characters with [Blessing] gain double ultimate effect' }
  ],
