...
export const bastetData = {
  ...
  skills: {
    ...
    auto: {
      ...
      description:
        'Deals wind damage equal to 72% of Attack to designated enemy and surrounding 4-meter range.',
    },
    ultimate: {
      name: 'Cat Bombing!',
      energyCost: '5', // e.g., '5'
      description:
        'Deals wind damage equal to 120% of Attack to designated enemy and surrounding 4-meter range.',
    },
    passive: {
      name: 'Cat Frenzy',
      description:
        'Every 5 normal attacks, the next normal attack deals wind damage equal to 120% of Attack to designated enemy and surrounding 4-meter range. With Awakening 2: Reduces trigger requirement from 5 to 4 normal attacks.',
    },
  },
