...
export const lancelotData = {
  ...
  skills: {
    ...
    auto: {
      ...
      cooldown: '4.0s',
      description: 'Adds a [Shield] equal to 5.1% of max HP to self. [Shield] can stack up to 30% of HP limit. Provides continuous defensive layering'
    },
    ultimate: {
      name: 'Blooming Knight\'s Flower',
      energyCost: '3',
      description: 'Immediately moves in front of specified enemy unit. All team characters receive 24% less damage for 15 seconds. Provides crucial team-wide damage reduction'
    },
    passive: {
      name: 'Lake Spirit\'s Blessing',
      description: 'When HP drops below 50% after taking damage: Recover 9.6% of maximum HP every 3 seconds. Effect lasts for 15 seconds. Provides excellent sustain in critical moments'
    }
  },
  ...
  teamSkill: {
    ...
    description: 'Own maximum HP increased by 10%. Defense increased by 10%. Enhances both survivability and damage output since abilities scale with HP',
    requirements: {
      faction: 'Avalon',
      element: 'Holy'
    }
  ...
  awakenings: [
    ...
    { level: 2, effect: 'When attacked, if [the character] has a shield, damage received is reduced by 10%. Synergizes perfectly with her auto-skill shield generation' },
    ...
    { level: 6, effect: 'Recovery amount from passive effect increased by 100%. Doubles the healing from Lake Spirit\'s Blessing (9.6% → 19.2% HP recovery)' }
  ],
  // Memory Card
  memoryCard: {
