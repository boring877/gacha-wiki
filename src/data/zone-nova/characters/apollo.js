...
export const apolloData = {
  ...
  skills: {
    ...
    auto: {
      ...
      description: 'Allied units gain 24% damage increase. [Pursuit] damage additionally increases by 36%. Triggers Brilliant stacking through passive system.'
    },
    ultimate: {
      name: 'Day Brilliance Chanting',
      energyCost: '8', // e.g., '5'
      description: 'Enters [Day Brilliance] state for 10 seconds. During transformation: Allied attack power increases by 120%. Apollo gains enhanced abilities: When releasing ultimate, triggers [Pursuit] attacks. Critical rate boost: 100% critical rate increase during transformation. Pursuit mechanics: Can trigger up to 5 pursuit attacks within range.'
    },
    passive: {
      name: 'Brilliant Verdict',
      description: 'Each skill use: All allies gain 1 layer [Brilliant]. [Brilliant] Effect: +2.4% critical rate and +4.8% critical damage per layer. Maximum 10 layers (24% crit rate + 48% crit damage at full stacks). Pursuit Synergy: Allied pursuit attacks grant additional [Brilliant] layers. Radiance System: Apollo gains [Radiance] stacks that enhance his capabilities.'
    }
  },
  ...
  teamSkill: {
    ...
    description: 'Battle start: Team damage increases by 10%. Every 500 attack power adds 5% team damage, maximum 6 times (30% max).',
    requirements: {
  ...
  awakenings: [
    { level: 1, effect: 'Allied characters dealing [Pursuit] damage can additionally gain 1 layer [Brilliant]. Each character can trigger once within 1 second maximum.' },
    ...
    { level: 4, effect: 'During [Day Brilliance] state, allied characters gain 10% elemental resistance penetration.' },
    { level: 5, effect: '[Ultimate] and [Passive] level and level cap +4.' },
    { level: 6, effect: 'During [Day Brilliance] state, Apollo\'s [Pursuit] additionally gains 50% critical damage.' }
  ],
