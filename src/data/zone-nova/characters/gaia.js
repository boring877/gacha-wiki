...
export const gaiaData = {
  ...
  teamSkill: {
    ...
    description:
      'Gaia gains +10% Max HP. At battle start: For every 5,000 Max HP Gaia has, her healing output increases by 5% (up to 6 stacks, max +30%).',
    requirements: {
      faction: 'Odius',
      element: 'Holy',
    },
...
export const gaiaSEO = {
  ...
  description:
    'Complete guide for 【Matriarch】Gaia in Zone Nova. Learn about her healing abilities, Motherly Love passive, team skills, awakening effects, and optimal build strategies for this powerful Odius faction support character.',
};
