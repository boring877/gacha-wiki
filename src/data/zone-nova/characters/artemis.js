...
export const artemisData = {
  ...
  skills: {
    normal: {
      ...
      description: 'Deals 120% attack power as wind damage to designated enemy unit. Standard attack scaling for consistent damage output.'
    },
    auto: {
      name: 'Moon Ancient Boxing',
      cooldown: '5.0s', // e.g., '5.0s'
      description: 'Automatically deals 240% attack power as wind damage to designated enemy and nearby enemies. Each hit restores 10% max HP. AoE damage with built-in sustain mechanism that triggers automatically.'
    },
    ultimate: {
      name: 'Silver Moon Judgment',
      energyCost: '3', // e.g., '5'
      description: 'Consumes 50% current HP. Teleports in front of designated enemy. Deals 264% attack power as wind damage to target and nearby enemies. High-risk, high-reward ability that activates low-HP bonuses.'
    },
    passive: {
      name: 'Moon Shadow Hunt',
      description: 'When HP is below 50%: All attacks deal additional 60% attack power as wind damage. Core low-HP mechanic that significantly amplifies damage output. Synergizes with ultimate\'s HP consumption.'
    }
  },
  ...
  teamSkill: {
    ...
    description: 'Self max HP increased by 10%. At battle start: For every 4,000 max HP, increase self attack power by 5% (maximum 6 times). Maximum scaling: 30% attack power boost at 24,000+ max HP.',
    requirements: {
