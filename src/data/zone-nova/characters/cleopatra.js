...
export const cleopatraData = {
  ...
  skills: {
    ...
    auto: {
      ...
      cooldown: '5.0s',
      description: 'Deals chaos damage equal to 168% of Attack to target and surrounding 4-meter range. Adds one layer of [Deception] debuff. With Memory Card: Additionally adds one layer of [Infiltration]'
    },
    ultimate: {
      name: 'Cultural Authority - Supreme Rule',
      energyCost: '8',
      description: '4-second channeling time. Deals chaos damage equal to 480% of Attack to all targets. If target has persistent damage layers: Additionally deals 48% Attack chaos damage up to 20 times. All ultimate damage is treated as persistent damage type'
    },
    passive: {
      name: 'Filthy Whispers',
      description: 'Each skill use grants one [Whisper] layer (maximum 5 layers). When team members use ultimates: Can consume [Whisper] to deal additional 120% Attack chaos damage + add one [Deception] layer. [Deception]: Every 3 seconds deals 19.2% Attack chaos damage, maximum 10 layers'
    }
  },
  ...
  teamSkill: {
    ...
    description: 'Self attack power increases by 10%. Battle start: Every 500 attack adds 3% penetration rate, maximum 6 times. Maximum penetration bonus: 18% (at 3,000+ attack)',
    requirements: {
      faction: 'Kemichi',
      element: 'Chaos'
    }
  ...
  awakenings: [
    ...
    { level: 2, effect: 'When releasing ultimate: Damage taken reduced by 20%. After releasing ultimate: Recover 2 energy' },
