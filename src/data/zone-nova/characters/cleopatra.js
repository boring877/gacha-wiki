...
export const cleopatraData = {
  ...
  memoryCard: {
    ...
    effects: [  // awakening levels 1-5
      "Attack increases by 24%, after a skill hits a target, applies one stack of [Corrosion], [Corrosion]: Deals 9% Chaos Damage every 2 seconds, stacks up to 5 times, lasts 10 seconds",
      "Attack increases by 28%, after a skill hits a target, applies one stack of [Corrosion], [Corrosion]: Deals 10.5% Chaos Damage every 2 seconds, stacks up to 5 times, lasts 10 seconds",
      "Attack increases by 32%, after a skill hits a target, applies one stack of [Corrosion], [Corrosion]: Deals 12% Chaos Damage every 2 seconds, stacks up to 5 times, lasts 10 seconds",
      "Attack increases by 36%, after a skill hits a target, applies one stack of [Corrosion], [Corrosion]: Deals 13.5% Chaos Damage every 2 seconds, stacks up to 5 times, lasts 10 seconds",
      "Attack increases by 40%, after a skill hits a target, applies one stack of [Corrosion], [Corrosion]: Deals 15% Chaos Damage every 2 seconds, stacks up to 5 times, lasts 10 seconds",
    ],
