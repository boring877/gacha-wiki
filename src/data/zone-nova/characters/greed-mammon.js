...
export const greedMammonData = {
  ...
  skills: {
    ...
    auto: {
      ...
      cooldown: '5.0s',
      description:
        'Deals 96% of Attack as chaos damage to enemies within a 3-meter radius around self. Automatically triggers every 5 seconds',
    },
    ultimate: {
      name: 'Seven Deadly Sins: Greed',
      energyCost: '5',
      description:
        'Normal Version: Deals chaos damage equal to 180% of Attack to designated enemy unit. [Enhanced Ultimate] Version: Deals chaos damage equal to 240% of Attack to enemies within a 4-meter radius around self. [Buffer] After an ally uses ultimate skill, can activate [Enhanced Ultimate] once within 5 seconds',
    },
    passive: {
  ...
  awakenings: [
    {
      level: 1,
      effect: 'When you have buff effects: Special skill critical damage increases by 20%',
    },
    {
      level: 2,
      effect: 'After using a special skill: Damage taken is reduced by 10% for 10 seconds',
    },
    ...
    { level: 5, effect: '[Ultimate] and [Passive] level and level cap +4' },
    {
      level: 6,
      effect:
        'After successfully casting an enhanced special skill, gain 1 additional energy point',
    },
  ],
