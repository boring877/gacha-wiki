...
export const friggaData = {
  ...
  teamSkill: {
    ...
    description:
      'After combat starts, reduces total damage dealt by all enemy units by 2.5%. For every 1000 attack power Frigga has, this effect increases by 100% (doubles), maximum increase of 300%. At 3000+ attack: 10% damage reduction (maximum).',
    requirements: {
