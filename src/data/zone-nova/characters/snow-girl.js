...
export const snowGirlData = {
  ...
  skills: {
    ...
    auto: {
      ...
      cooldown: '5.0s',
      description:
        'Heals all friendly units, restoring HP equal to 33.6% + 182 of own attack power',
    },
    ultimate: {
      ...
      energyCost: '3',
      description:
        'Heals all friendly units, restoring HP equal to 47.2% + 182 of own attack power',
    },
    passive: {
      name: 'Frost Blessing',
      chineseName: '冰霜祝福',
      level: '10+4',
      description:
        'Ultimate skill healing can add a 5-second continuous recovery effect to the target, recovering 75% of Snow Girls attack power + 29 HP per second',
    },
  },
  ...
  awakenings: [
    {
      level: 1,
      effect:
        'After ultimate skill heals friendly units, additionally increases targets damage dealt by 10% for 10 second',
    },
    {
      level: 2,
