...
export const jeanneDArcData = {
  ...
  skills: {
    ...
    auto: {
      ...
      level: '10+4',
      cooldown: '8.0s',
      description: 'After short cast, recovers the friendly unit with lowest current HP ratio, self attack power 80.5%+445 HP, continuously heals 3 times'
    },
    ultimate: {
  ...
  awakenings: [
    ...
    { level: 2, effect: 'After consuming [Sacred] to heal targets, that target receives 10% less damage for 5 seconds, can be triggered multiple times with extended duration' },
