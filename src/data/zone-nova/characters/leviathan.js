...
export const leviathanData = {
  ...
  skills: {
    ...
    auto: {
      ...
      cooldown: '5.0s',
      description: 'Deals wind damage equal to 120% of Attack to designated enemy unit. Gains 2 layers of [Mark]'
    },
    ultimate: {
      name: 'Seven Deadly Sins: Jiāolú (七大罪：娇炉)',
      energyCost: '5',
      description: 'Deals wind damage equal to 600% of Attack to designated enemy unit. Immediately launches 1 pursuit attack against target. Subsequent pursuit attacks do not consume marks'
    },
    passive: {
      name: 'Grudge Deep Chain (怨恨深链)',
      description: 'When our allies activate skills and hit enemies, consumes 1 layer of [Mark] and triggers pursuit. Pursuit deals wind damage equal to 180% of Attack. Mark System: Gain marks from Auto Skill, consume for pursuit attacks'
    }
  },
  ...
  awakenings: [
    { level: 1, effect: 'Self triggers [Skills] can trigger activation effects. Improves skill synergy and combo potential' },
    { level: 2, effect: '[Pursuit] critical rate increased by 20%. Significantly boosts pursuit attack reliability' },
    { level: 3, effect: '[Skills] and [Normal Attack] level and level cap +4' },
    { level: 4, effect: '[Pursuit] damage increased by 20%. Major boost to her primary damage source' },
    { level: 5, effect: '[Ultimate] and [Passive] level and level cap +4' },
    { level: 6, effect: 'When releasing [Ultimate] skills, the number of pursuit attacks triggered changes from 1 to 2. Doubles ultimate pursuit potential' }
  ],
