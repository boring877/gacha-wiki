// June 17th Maintenance - Zone Nova
// Official Maintenance Content

export const june17MaintenanceData = {
  // Basic Information
  ...
  officialUpdate: {
    content: [
      'Maintenance Details',
      '',
      'Maintenance Time: June 17, 2025, 14:00 - 16:00 (local server time)',
      '',
      'Details: During maintenance, captains will be unable to log in. Please prepare accordingly.',
      '',
      '618 Carnival Special Event',
      '',
      'Rewards: Summoning normal banner x5, Stamina Refill x15 (sent via in-game mail after maintenance)',
      '',
      'Eligibility: Captains who logged in before July 1, 2025, 23:59',
      '',
      'Starter Gift Pack: Available after maintenance; access via Shop → Featured → Starter Gift Pack',
      '',
      'Compensation Details',
      '',
      'Maintenance Compensation: 300 Quartz',
      '',
      'Eligibility: Captains who logged in before July 1, 2025, 23:59',
      '',
