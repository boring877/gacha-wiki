// Athena Limited Recruitment - Zone Nova
// Announcement Data Structure

export const athenaRecruitmentData = {
  // Basic Information
  ...
  officialUpdate: {
    content: [
      'Dear Captains:',
      '',
      'Thank you for everyone\'s continued support of "ZONE NOVA"! The following are the details for the next [Limited Recruitment] character:',
      '',
      ...
      '',
      'Event Duration: After server launch on 2025/06/24 ~ 2025/07/08 03:59:59',
      '',
      'Event Details: Through the [Limited Character Recruitment] event, you can obtain Athena and through the [Limited Memory Recruitment] event obtain her exclusive memory "Sadistic Appearance".'
    ]
  },
...
export default athenaRecruitmentData; 