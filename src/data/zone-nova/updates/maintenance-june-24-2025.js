...
export const june24MaintenanceData = {
  ...
  officialUpdate: {
    content: [
      ...
      'Our characters deal 100% increased pursue damage (extra damage) to enemies',
      'Our characters additionally gain 1 layer of [Thunder Mark] after dealing pursue damage (extra damage) to enemies, when our characters deal damage to enemies with 10 layers of [Thunder Mark], they will trigger [Thunder Mark], dealing 300% of own attack power in divine damage to enemies and increasing pursue damage (extra damage) by 50% for the next 5 seconds',
      '',
