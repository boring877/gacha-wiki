...
export const idleIncomeBugfixData = {
  ...
  // TL;DR Summary
  tldr: [
    'Some captains abnormally obtained extra Energy Supplements due to an idle income system anomaly. The development team will reclaim abnormal Energy Supplements from affected accounts and provide compensation (Energy Supplement ×5) to all players who logged in before June 7, 2025.'
  ],
  ...
  officialUpdate: {
    ...
    content: [
      ...
      '',
      '📅 Eligibility: Captains who have logged into the game before June 7, 2025 23:59',
      '',
      '📬 Distribution Method: Compensation will be distributed through in-game mail'
    ]
  },
