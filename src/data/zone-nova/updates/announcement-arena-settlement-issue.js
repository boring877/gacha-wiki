export const arenaSettlementIssueData = {
  ...
  officialUpdate: {
    ...
    content: [
      'Thank you for your continued support of ZONE NOVA! We recently resolved an issue where the Arena reward system failed to distribute rewards properly. Additionally, server upgrades have been implemented to address latency during peak hours/weekends.',
      '',
      'We sincerely apologize for any inconvenience caused.',
      '',
      'Compensation Details:',
      '',
      'All players who logged in before July 15, 2025, 23:59 (UTC+0) will receive:',
      '',
      '• 800 Gems',
