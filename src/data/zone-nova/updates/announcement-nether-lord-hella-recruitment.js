// Nether Lord Hella Limited Recruitment - Zone Nova
// Announcement Data Structure

export const netherLordHellaRecruitmentData = {
  // Basic Information
  ...
  officialUpdate: {
    content: [
      'Dear Captains:',
      '',
      'Thank you for your continued support of "ZONE NOVA"! Below are the details for the next [Limited Recruitment] character:',
      '',
      'Limited Recruitment Character',
      '',
      'Character: Legendary Character [Nether Lord] Hella (Wandering Messenger, Blended Pool)',
      '',
      '[Nether Lord] Hella is a legendary character with wandering messenger attributes, possessing powerful output capabilities that rivals human wind and distance, and more terrifyingly, her dual forms can respond to different combat environments.',
      '',
      ...
      'Activity Details: Through the [Limited Character Recruitment] activity, players can obtain [Nether Lord] Hella and [Limited Pursuit Memory] activity-exclusive equipment.',
    ],
  },
...
export default netherLordHellaRecruitmentData;
