export const apepRecruitmentData = {
  ...
  officialUpdate: {
    ...
    content: [
      'Thank you for your continued support of ZONE NOVA! Below are the details for the next [Limited Time Recruitment] character:',
      '',
      '**Limited Time Recruitment Character**',
      '',
      '**Character**: Legendary Character Apep (Striker, Wind)',
      '',
      "Apep is a Wind-attribute Striker character. The scythe in her hands has harvested countless enemies. On the battlefield, she fights like a fearless war machine that decimates foes. Every time enemies think they can compensate for the difference in combat power with numbers, they instead fall into Apep's trap, because... Apep's greatest strength is her sustained combat ability...",
      '',
      ...
      '**Event Period:**',
      '',
      '2025/11/11 14:15 ~ 2025/11/25 03:59',
      '',
      '**Event Details:**',
      '',
      'Through the [Limited Character Recruitment] event, you can obtain Apep and also acquire her exclusive memory through the [Limited Memory Recruitment] event.',
    ],
  },

  sourceInfo: {
    source: 'Official ZONE NOVA announcement - Apep Limited Recruitment',
    verified: true,
