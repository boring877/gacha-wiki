...
export const september16MaintenanceData = {
  ...
  officialUpdate: {
    ...
    content: [
      ...
      '• Introduction: Legendary Character Yuis (Attacker, Divine Saint) is a Divine Saint attribute rogue character, also a pursuit-type character who strengthens herself by coordinating with other teammates\' "tracking" to cause lethal damage to enemies.',
      '',
      'Rerun [Limited Pursuit Recruitment] - Frozen Heart',
      '',
      '• Opening time: 2025/09/23 14:15 ~ 2025/09/30 03:59:59',
      '• Matching class: Attacker',
      "• Introduction: This is the deepest secret place in Yuis' heart. The frozen heart contains her determination and perseverance as the Deity of Judgment. Captains will have the opportunity to glimpse the purity and emotions deep within this heart.",
      '',
