...
export const GAMES: Game[] = [
  ...
  },
  {
    ...
    name: 'Taimanin Squad',
    slug: 'taimanin-squad',
    description: 'Collecting RPG • Taimanin Franchise • Character Collection • Now on Steam',
    image: TaimaninSquadIcon,
    url: '/guides/taimanin-squad/',
    status: 'active',
    themeColor: '#6b5b7a',
    sections: ['Characters', 'Equipment', 'Guides', 'Resources'],
  },
  {
    id: 'star-savior',
    name: 'Star Savior',
  ...
  },
  {
    ...
    image: 'https://pub-dd9a9c01bc7a43d0bb977b255815a5c4.r2.dev/agent-x/gameimg/icon-3001.webp',
    url: '/guides/agent-x/',
    status: 'active',
    themeColor: '#d4a017',
