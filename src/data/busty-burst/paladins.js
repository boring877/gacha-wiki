export const BUSTY_BURST_PALADINS = [
  {
    id: 'the_strongest_witch_shaharl',
    characterId: 2081,
  ...
  {
    id: 'golem_summoner_nerys',
    characterId: 2042,
    name: 'Golem Summoner Nerys',
    fileName: 'Golem_Summoner_Nerys',
    rarity: 'SSR',
    element: 'Mind',
    role: 'Support',
    tier: 'A',
  ...
  {
    id: 'want_some_beer_stenrina',
    characterId: 2091,
    name: 'Want some beer?: Stenrina',
    fileName: 'Want_Some_Beer_Stenrina',
    rarity: 'SR',
    element: 'Mind',
    role: 'Support',
    tier: 'A',
  ...
  {
    id: 'new_years_feast_box_lynette',
    characterId: 2101,
    name: "New Year's Feast Box: Lynette",
    fileName: 'New_Years_Feast_Box_Lynette',
    rarity: 'SR',
    element: 'Mind',
    role: 'Support',
    tier: 'B',
  ...
  {
    id: 'underboob_cheerleader_vanessa',
    characterId: 2128,
    name: 'Underboob Cheerleader: Vanessa',
    fileName: 'Underboob_Cheerleader_Vanessa',
    rarity: 'SSR',
    element: 'Water',
    role: 'Support',
    tier: 'S',
  ...
  // Units with full body art added to the roster for the tier list (2026-09-06);
  // tier placement pending — they render under the NYR tier on the tier list.
  {
