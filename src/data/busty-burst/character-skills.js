...
export const BUSTY_BURST_CHARACTER_SKILLS = {
  ...
  giselle: {
    ...
    skill2: {
      ...
      description: 'Deals physical damage to the 3 nearest enemies and inflicts Physical DEF -21%-40 for 8 seconds',
      type: 'damage',
      target: 'nearest enemies',
    },
    skill3: {
      name: "Knight's Pride",
      description: 'Applies Physical Crit Damage UP to self for 10 seconds and inflicts Accuracy DOWN on all enemies for 10 seconds',
      type: 'buff',
      target: 'self',
    },
    ultimate: {
      name: 'Hurricane Charge',
      description: 'Deals physical damage to the 3 nearest enemies, inflicts Block DOWN (Lv5: -25) for 8 seconds and applies Physical ATK UP (Lv5: +30%) to self for 8 seconds',
      type: 'damage',
      target: 'nearest enemies',
      ranks: {
        R1: '280% + 300 | Block -10 (8s), Phys ATK +15% (self, 8s)',
        R2: '320% + 400 | Block -15 (8s), Phys ATK +20% (self, 8s)',
        R3: '350% + 450 | Block -19 (8s), Phys ATK +24% (self, 8s)',
        R4: '380% + 500 | Block -22 (8s), Phys ATK +27% (self, 8s)',
        R5: '400% + 550 | Block -25 (8s), Phys ATK +30% (self, 8s)',
      },
    },
    passive1: 'Physical Attack +389, Max HP +2896',
    passive2: 'Ultimate Damage +15%, Accuracy +20',
  },
  ...
  inrine: {
    ...
    skill3: {
      ...
      description: 'Applies Hit-Based Physical Damage UP(150%+500, 1 hit) to self for 4 seconds and Debuff Resistance UP for 4 seconds',
      type: 'buff',
      target: 'self',
    },
    ultimate: {
      name: 'Ten-Thousand Blade Flash',
      description: 'Deals physical damage to the 3 nearest enemies and inflicts Physical DEF DOWN (Lv5: -25%) for 10 seconds and Block DOWN (Lv5: -25) for 10 seconds',
      type: 'damage',
      target: 'nearest enemies',
      ranks: {
        R1: '280% + 300 | Phys DEF -10%, Block -10 (10s)',
        R2: '330% + 400 | Phys DEF -15%, Block -15 (10s)',
        R3: '370% + 500 | Phys DEF -19%, Block -19 (10s)',
        R4: '400% + 550 | Phys DEF -22%, Block -22 (10s)',
        R5: '420% + 600 | Phys DEF -25%, Block -25 (10s)',
      },
    },
    passive1: 'Physical Attack +389, Accuracy +20',
    passive2: 'Skill Damage +30%, Accuracy +20',
  },
  ...
  henrietti: {
    ...
    skill3: {
      ...
      description: 'Restores HP to nearest 3 allies and applies HP Regen 5%+150 for 5 seconds',
      type: 'heal',
      target: 'nearest allies',
    },
    ultimate: {
      name: 'Galc Special - Explosive Potion Shell!',
      description: 'Deals physical damage to all enemies and inflicts Stun (Lv5: 2s) and Blind (Lv5: 6s)',
      type: 'damage',
      target: 'all enemies',
      ranks: {
        R1: '300% + 300 | Stun 1s, Blind 4s',
        R2: '360% + 450 | Stun 1s, Blind 4s',
        R3: '409% + 550 | Stun 1.5s, Blind 5s',
        R4: '440% + 650 | Stun 2s, Blind 5s',
        R5: '470% + 700 | Stun 2s, Blind 6s',
      },
    },
    passive1: 'Max HP +2896',
    passive2: 'Action Speed +10',
  },
  ...
  vanessa: {
    ...
    skill3: {
      name: "Don't run...",
      description: 'Applies Accuracy UP and Physical Crit Damage UP to self for 11 seconds',
      type: 'buff',
      target: 'self',
    },
    ultimate: {
      name: 'Are you going to behave now?',
      description: 'Deals physical damage to the nearest enemy and inflicts Block DOWN (Lv5: -25) for 12 seconds',
      type: 'damage',
      target: 'nearest enemy',
      ranks: {
        R1: '1500% + 600 | Block -10 (12s)',
        R2: '1710% + 800 | Block -15 (12s)',
        R3: '1850% + 950 | Block -19 (12s)',
        R4: '2000% + 1100 | Block -22 (12s)',
        R5: '2100% + 1200 | Block -25 (12s)',
      },
    },
    passive1: 'Physical Attack +259',
    passive2: 'Skill Damage +20%, Accuracy +15',
  },
  ...
  viatrice: {
    ...
    skill2: {
      ...
      description: 'Deals magic damage to the 3 nearest enemies and inflicts Burn for 15 seconds and Block DOWN for 8 seconds',
      type: 'damage',
      target: 'nearest enemies',
    },
    skill3: {
      name: 'Swoosh~ Boom boom~',
      description: 'Applies Hit-Based Shield (100%, 1 hit) to self for 25 seconds and Magic ATK UP for 12 seconds',
      type: 'buff',
      target: 'self',
    },
    ultimate: {
      name: "It doesn't count unless it burns",
      description: 'Deals magic damage to the nearest enemy and inflicts Burn (Lv5: -4000/s) for 15 seconds and Fire Type Damage Taken UP (Lv5: +20%) for 8 seconds',
      type: 'damage',
      target: 'nearest enemy',
      ranks: {
        R1: '900% + 900 | Burn -2000/s (15s), Fire Dmg Taken +10% (8s)',
        R2: '1080% + 1100 | Burn -2500/s (15s), Fire Dmg Taken +13% (8s)',
        R3: '1210% + 1250 | Burn -3000/s (15s), Fire Dmg Taken +16% (8s)',
        R4: '1300% + 1350 | Burn -3500/s (15s), Fire Dmg Taken +18% (8s)',
        R5: '1350% + 1400 | Burn -4000/s (15s), Fire Dmg Taken +20% (8s)',
      },
    },
    passive1: 'Magic Attack +389, Block +15',
    passive2: 'Skill Damage +30%, Max HP +2896',
  },
  ...
  trish: {
    ...
    skill2: {
      ...
      description: 'Applies Hit-Based Damage UP (35%+400, 3 hits) and Accuracy UP to all allies for 10 seconds',
      type: 'buff',
      target: 'all allies',
    },
    skill3: {
      name: 'Tracy Special - Stamina Drink',
      description: 'Applies HP Regen to all allies for 10 seconds and Healing Shield for 15 seconds, removes debuffs',
      type: 'heal',
      target: 'all allies',
    },
    ultimate: {
      name: 'Tracy Special - Ultra Drink!!',
      description: 'Applies HP Regen UP (Lv5: +15%) to all allies for 5 seconds and Physical ATK UP (Lv5: +35%) and Magic ATK UP (Lv5: +35%) for 10 seconds',
      type: 'buff',
      target: 'all allies',
      ranks: {
        R1: 'HP Regen +11% (5s), Phys ATK +20%, Mag ATK +20% (10s)',
        R2: 'HP Regen +12% (5s), Phys ATK +25%, Mag ATK +25% (10s)',
        R3: 'HP Regen +13% (5s), Phys ATK +29%, Mag ATK +29% (10s)',
        R4: 'HP Regen +14% (5s), Phys ATK +32%, Mag ATK +32% (10s)',
        R5: 'HP Regen +15% (5s), Phys ATK +35%, Mag ATK +35% (10s)',
      },
    },
    passive1: 'Physical DEF +211, Magic DEF +211',
    passive2: 'Healing Received +20%, Max HP +2896',
  },
  ...
  lycorys: {
    ...
    skill2: {
      ...
      description: 'Deals physical damage to the farthest enemy and inflicts Action Speed DOWN -20% for 12 seconds and Accuracy DOWN for 12 seconds',
      type: 'damage',
      target: 'farthest enemy',
    },
    skill3: {
      name: 'I wonder if it\'ll work... hehehe',
      description: 'Deals physical damage to the farthest enemy and inflicts Dispel for 1 second and Deadly Poison (stackable) for 6 seconds',
      type: 'damage',
      target: 'farthest enemy',
    },
    ultimate: {
      name: 'Hehehe... my greatest masterpiece ever!',
      description: 'Deals physical damage to the farthest enemy and inflicts Paralysis (Lv5: 6s) and Deadly Poison (Lv5: -10000/s) for 8 seconds',
      type: 'damage',
      target: 'farthest enemy',
      ranks: {
        R1: '900% + 1000 | Paralysis 4s, Deadly Poison -6000/s (8s)',
        R2: '1080% + 1150 | Paralysis 5s, Deadly Poison -7000/s (8s)',
        R3: '1210% + 1300 | Paralysis 5s, Deadly Poison -8000/s (8s)',
        R4: '1300% + 1400 | Paralysis 6s, Deadly Poison -9000/s (8s)',
        R5: '1350% + 1500 | Paralysis 6s, Deadly Poison -10000/s (8s)',
      },
    },
    passive1: 'Action Speed +10, Physical Attack +389',
    passive2: 'Skill Damage +30%, Max HP +2896',
  },
  ...
  katisha: {
    ...
    skill3: {
      name: "I'm not naive",
      description: 'Inflicts Block DOWN and Accuracy DOWN on the 3 nearest enemies for 7 seconds',
      type: 'debuff',
      target: 'nearest enemies',
    },
    ultimate: {
      name: 'Virne Sacred Binding - Chain Shackles',
      description: 'Deals physical damage to the nearest enemy and inflicts Action Speed DOWN (Lv5: -30) for 10 seconds and Silence (Lv5: 5s)',
      type: 'damage',
      target: 'nearest enemy',
      ranks: {
        R1: '1019% + 800 | Action Speed -15 (10s), Silence 3s',
        R2: '1230% + 950 | Action Speed -20 (10s), Silence 4s',
        R3: '1380% + 1100 | Action Speed -24 (10s), Silence 4s',
        R4: '1470% + 1200 | Action Speed -27 (10s), Silence 5s',
        R5: '1530% + 1300 | Action Speed -30 (10s), Silence 5s',
      },
    },
    passive1: 'Action Speed +10',
    passive2: 'Skill Damage +20%, Physical Attack +130',
  },
};
