...
export const skills = {
  "skills": [
    ...
    },
    {
      ...
      "description": "all enemies12 Physical Defense -30 DOWN and Accuracy -9 DOWN for 12 seconds , 50%% chance to2s Stun for",
      "descriptionLv1": "all enemies12 Physical Defense -30 DOWN and Accuracy -9 DOWN for 12 seconds , 50%% chance to2s Stun for",
      "descriptionLv90": "all enemies12 Physical Defense -210 DOWN and Accuracy -18 DOWN for 12 seconds , 50%% chance to2s Stun for",
      "target": "All Enemies",
      "castTime": 1.7,
      "damageScaling": null,
      "baseDamage": null,
