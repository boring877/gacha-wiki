...
export const skills = {
  "skills": [
    ...
    },
    {
      ...
      "description": "Deals magic damage to 1 farthest enemy, applies 3s, 3s, 10s Accuracy -15 DOWN",
      "descriptionLv1": "Deals magic damage to 1 farthest enemy, applies 3s, 3s, 10s Accuracy -15 DOWN",
      "descriptionLv90": "Deals magic damage to 1 farthest enemy, applies 3s, 3s, 10s Accuracy -33 DOWN",
      "target": "Back Enemy",
      "castTime": 0.6,
