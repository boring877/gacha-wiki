...
const RAW_TEAMS = [
  {
    ...
    description: 'Emily charges the whole team\'s ultimates, Patra drops Magic Resistance by up to 20% for 30 seconds, and Macak\'s 12-hit Extreme plus Xuanji\'s executions land inside that window. Patra\'s Class Skill also auto-reloads whenever an allied Arcanist ults, so the shred keeps refreshing itself.',
  ...
  },
  {
    ...
    description: 'Jenny and Xuanji pile on Stagger until the target drops, then the execution skills come out while Maro\'s auto is giving the whole team +10% damage and 16% extra vulnerability on the victim. Carmen holds the line so the casters never have to dodge-cancel their rotations.',
    rotation: 'Carmen opens with taunt, Jenny staggers the pack, and once the target is down Xuanji and Jenny\'s execution windows delete it inside Maro\'s amplified damage. Keep Maro\'s Class Skill on cooldown for the Magic Attack aura.',
    flex: 'Dusan and Leed are the budget execution spares. Against bosses that resist Mental, swap Jenny for Lucia.',
  },
  {
    id: 'sustain-wall',
