...
export const damageMechanicsIndex = {
  meta: {
    ...
    description:
      "Complete collection of Silver and Blood damage mechanics, character calculations, and mathematical formulas. Your one-stop guide for understanding the game's combat system.",
  ...
  mechanicsCategories: [
    ...
    },
    {
      ...
      description:
        'Advanced calculations for characters with complex abilities and unique mechanics',
      icon: '👥',
