...
export const eventData = {
  ...
  officialUpdate: {
    ...
    rewards: [
      // Optional: for events with rewards
      'Reward 1',
      'Reward 2',
    ],
    duration: {
      // Optional: for time-limited events
      start: 'December 1, 2024 00:00',
      end: 'December 14, 2024 23:59',
      timezone: 'Server Time',
    },
    requirements: [
      // Optional: for events with requirements
      'Requirement 1',
      'Requirement 2',
    ],
  },
  gameplayChanges: [
    // Optional: for updates that affect gameplay
    'Change 1',
    'Change 2',
  ],
  bugFixes: [
    // Optional: for maintenance updates
    'Bug fix 1',
    'Bug fix 2',
  ],
  sourceInfo: {
