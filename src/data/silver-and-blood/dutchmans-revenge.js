...
export const dutchmansRevengeData = {
  meta: {
    ...
    description: "Master Dutchman's Revenge infiltration mode in Silver and Blood. Complete walkthrough of Future Artifacts system, Dalcarlo's missions, and Tarot character strategies.",
    gameTitle: "Dutchman's Revenge",
    keywords: "Dutchman's Revenge, Silver and Blood, Future Artifacts, infiltration guide, Dalcarlo, Tarot characters, puzzle mode, enhancement materials",
    ogTitle: "Dutchman's Revenge - Silver and Blood Infiltration Guide",
    ogDescription: "Complete guide to Dutchman's Revenge mode featuring Future Artifacts, infiltration mechanics, and strategic gameplay in Silver and Blood."
  },

  intro: {
    text: "A black cat steers a ghost ship through mystifying, fog-laden waters. Let's see how she achieves her goal— sneaking aboard the Church's vessel under cover of night to seize Future Artifacts coveted by various Factions."
  },
  ...
  futureArtifacts: {
    ...
    overview: {
      ...
      description: "Future Artifacts are an advanced way to enhance a Vassal's combat abilities. Only by equipping a suitable Artifact for a Vassal can their combat potential be maximized."
    },

    artifactGallery: {
      title: "Artifact Gallery",
      description: "Your Future Artifacts collection. View them, equip them, and enhance them all in one place."
    },
