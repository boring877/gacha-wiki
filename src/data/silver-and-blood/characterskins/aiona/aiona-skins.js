...
export const aionaSkinsData = {
  ...
  skins: [
    ...
    },
    {
      ...
      type: 'mp4',
      mediaUrl: 'https://res.cloudinary.com/dtiiaqlah/video/upload/v1752616267/AionaSkin1_cjsgpe.mp4',
      thumbnailUrl: 'https://res.cloudinary.com/dtiiaqlah/image/upload/v1752617181/New_Outfit_Starry_Eyed_Aiona_Pearlescent_Dreams_vsqbmi.webp',
