...
export const summonFaqData = {
  meta: {
    ...
    description:
      'Master Silver and Blood summoning with our complete guide covering summon rates, pity system, Future Artifacts, Moon Tears, and optimal character acquisition strategies.',
    gameTitle: 'Summon FAQ',
    keywords:
      'Silver and Blood, summon guide, gacha rates, pity system, Moon Tear, Future Artifacts, character summoning, limited banners',
    ogTitle: 'Silver and Blood Summon FAQ - Complete Gacha Guide',
    ogDescription:
      'Everything you need to know about Silver and Blood summoning: rates, pity mechanics, currencies, and strategies for optimal character acquisition.',
  },
  ...
  selectionSystem: {
    ...
    selectionProcess:
      'Choose 5 SSR characters from each faction: Church, Kingdom, and Bloodborn (15 total)',
  ...
  faq: [
    {
      ...
      answer:
        'Common Summons pity is separate from Limited events. Limited Summons pity carries over between all limited summon events and does not reset when an event ends.',
    },
    {
      question: 'How does the Featured Character Protection work?',
      answer:
        "When you get an SSR, there's a 50% chance it's the featured character. If it's not featured or common Ancestral, an \"Inspired summon\" is triggered, guaranteeing your next SSR will be featured or common Ancestral until you get the featured character.",
    },
    {
      question: 'What are Common Ancestral Characters?',
      answer:
        'These are specific characters with consistent rates: Limine, Transcendent Hati, Incendiary Agares, Transcendent Ami, Seth, and Transcendent Noah. They each have a 0.0833% rate in both Common and Limited summons.',
    },
    {
      question: 'When should I use the Selection System?',
      answer:
        'The Selection System unlocks after 40 Common Summon pulls. Choose wisely - select 5 SSR characters from Church, Kingdom, and Bloodborn factions (15 total) as any SSR from these factions will be from your selection.',
    },
    {
      question: "What's the difference between Spirits and Spirit Scraps?",
      answer:
        'Spirits are obtained instead of duplicate characters and are used to increase character level caps. Spirit Scraps are obtained when you have max Spirit Siphon materials and can be spent in the Covenant Shop.',
    },
    {
      question: 'Should I save Fragrant Residue?',
      answer:
        "You get 1 Fragrant Residue per pull. Collect 200 to exchange for 1 copy of Spirits, which is valuable for character progression. It's generally worth saving up for this exchange.",
    },
  ],
};
