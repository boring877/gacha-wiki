...
export const bella = {
  ...
  skills: [
    ...
    },
    {
      ...
      type: 'Special',
      description:
        "When the battle begins, Bella summons 2 Animated Puppets every 8 sec for 20 sec. The puppets will have 68.0% of Bella's ATK, as well as 68.0% of her DEF and HP, and will be targeted in place of Bella. Animated Puppet: A summon that performs Basic ATK. Only 3 can exist at the same time.",
    },
    {
  ...
  mechanics: {
    moonPhaseEffect:
      'New Moon: Ultimate Bloodsoul Cost -1, +25% DMG. Enhanced summoning abilities and puppet control.',
    attackTypeInfo:
      'M.DMG: Magical damage through puppet manipulation and sorcery. Reduced by M.DEF. Enhanced by summoning mechanics.',
    equipmentNote:
      'Medium Equipment: Balanced stats for both defense and summoning support, ideal for sustained puppet control.',
  },
};
