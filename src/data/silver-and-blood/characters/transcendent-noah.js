...
export const transcendentNoah = {
  ...
  skills: [
    {
      ...
      type: 'Normal Attack',
      description:
        'Releases a phantasm at the target which strikes each enemy in its path twice, dealing a total of 210.0% ATK (P. DMG).',
    },
    {
      name: 'Supernatural Presence',
      type: 'Special',
      description:
        'After every 2 Basic ATK(s), deals 225.0% ATK (P. DMG) to the target, stealing its soul to summon a Shade. Shade: A summon that performs ranged Basic ATK in sync with Transcendent Noah. Only 5 can exist at the same time.',
    },
    {
  ...
  mechanics: {
    moonPhaseEffect:
      'Full Moon: Ultimate Bloodsoul Cost -1, +25% DMG. Enhanced Shade summoning and death-based abilities.',
    attackTypeInfo:
      'P.DMG: Physical damage through phantasms and soul manipulation. Reduced by P.DEF. Enhanced by Shade synergy and effective range.',
    equipmentNote:
      'Light Equipment: Focused on offensive capabilities with high ranged attack stats and summoning bonuses.',
  },
};
