...
export const thibault = {
  ...
  skills: [
    ...
    },
    {
      ...
      type: 'Special',
      description:
        'Activates every 10 sec, dealing 300.0% ATK (M. DMG) to the target and tracked target.',
    },
    {
      name: 'Desert Burial',
      type: 'Passive',
  ...
  mechanics: {
    moonPhaseEffect:
      'Full Moon: Ultimate Bloodsoul Cost -1, +25% DMG. Enhanced desert magic and AOE damage capabilities.',
    attackTypeInfo:
      'M.DMG: Magical damage through desert sorcery and sandstorm magic. Reduced by M.DEF. Enhanced by critical damage scaling.',
    equipmentNote:
      'Light Equipment: Attack-focused gear with high offensive stats, ideal for maximum magical damage output.',
  },
};
