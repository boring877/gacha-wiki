...
export const acappella = {
  ...
  image: 'acappella', // official image
  ...
  skills: [
    ...
    },
    {
      ...
      cost: 3,
      description:
        'Begins Channeling for 10 sec. During this period, Bloodsoul Recovery Rate for all allies will be increased by 35.0%. Every 1 sec, Acappella gains 1 Note.',
    },
  ],
  ...
  mechanics: {
    moonPhaseEffect:
      'Crescent Moon: Ultimate Bloodsoul Cost -1, +25% DMG. Enhanced note generation and channeling abilities.',
    attackTypeInfo:
      'M.DMG: Magical damage through divine music and holy harmonies. Reduced by M.DEF. Enhanced by buff synergy.',
    equipmentNote:
      'Light Equipment: High offensive stats for maximum magical damage output and buff effectiveness.',
  },
};
