...
export const joan = {
  ...
  mechanics: {
    moonPhaseEffect:
      'Crescent Moon: Ultimate Bloodsoul Cost -1, +25% DMG. Enhanced electrified state and induction effects.',
    attackTypeInfo:
      'P.DMG: Physical damage through electrified weapons. Reduced by P.DEF. Enhanced by cone attacks and electrified state.',
    equipmentNote:
      'Medium Equipment: Balanced stats for both offense and survival, ideal for sustained AoE combat.',
    specialAbilities:
      'Electrified: Basic ATK transforms into an electrified circular saw. ATK SPD is increased during this time. Induction: Stacking debuff that deals damage and converts to stun at 8 stacks.',
  },
};
