...
export const spectralGilrain = {
  ...
  mechanics: {
    moonPhaseEffect:
      'Crescent Moon: Ultimate Bloodsoul Cost -1, +25% DMG. Enhanced teleportation abilities and apparition summoning.',
    attackTypeInfo:
      'P.DMG: Physical damage through spectral attacks and phantom strikes. Reduced by P.DEF. Enhanced by apparition synergies and teleportation positioning.',
    equipmentNote:
      'Light Equipment: Attack-focused gear with high offensive stats, ideal for maximum assassination damage and mobility.',
  },
};
