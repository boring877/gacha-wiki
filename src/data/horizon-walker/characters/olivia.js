...
const rawOliviaData = {
 ...
 bladebreaker: {
  name: 'Bladebreaker',
  description:
  'Activates Level 1 Passive Skill [Bladebreaker]. [Bladebreaker]: During your turn, always blocks attacks from the front. Block Chance is capped at 75%.',
 },
 marlon: {
  name: 'Marlon',
 ...
 limitlessForm: {
  ...
  cooldown: 0,
  description:
  'Removes Critical Chance entirely but increases Melee ATK by {40,60,80,100,120,140,160,180,200,220}% while in combat. Ignores {1050,1100,1150,1200,1250,1300,1350,1400,1450,1500} Slash DEF when attacking.',
 },
 ascendantThousandfoldExecution: {
  ...
  cooldown: 0,
  description:
  'At the start of each round, gain 3 stacks of [Ascendant]. [Ascendant]: When it is the enemy\'s turn, perform an additional counterattack with \'Thousand Execution\' against the closest enemy. Thousand Execution Consumes 1 stack of [Ascendance] to activate. Performs a powerful upward slash against the nearest enemy. Deals {100,110,120,130,140,150,160,170,180,190}% Slash DMG in a 90º, 8m cone and sets AP to 159.',
 },
 thousandExecution: {
  gameKey: 'StandingLikeSky',
  icon: 'UI_SkillIcon_StandingLikeSky',
