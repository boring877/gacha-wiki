...
const rawEveretteData = {
 ...
 uniqueTraits: {
  ancientArchmage: {
   ...
   description:
    'Activates the Level 1 passive skill [Ancient Archmage]. [Ancient Archmage]: Whenever Everette uses a skill other than Standby or a Combat skill, her Magic ATK increases by 100%. This effect is removed at the end of the turn in which she uses a Standby or Attack skill. Can stack up to 5 times.',
  },
  worldContract: {
   name: 'The World Contract',
   description:
    'Activates the Level 2 passive skill [Temporal Manipulation]. [Temporal Manipulation]: During battle, grants all allies the [Time Acceleration] effect and all enemies the [Time Deceleration] effect. - [Time Acceleration]: Increases SPD by 10, AP Recovery by 10, and Immaterial DEF by 100. - [Time Deceleration]: Reduces ACC by 10%, Evasion by 10%, and Immaterial DEF by 100.',
  },
  highlandElf: {
   name: 'Highland Elf',
