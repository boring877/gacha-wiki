...
const rawBergaData = {
 ...
 uniqueTraits: {
  shutInAffinity: {
   ...
   description:
    'Activates the Level 1 passive skill [Healthy Adjustment]. - [Healthy Adjustment]: Recovers HP equal to 180% of Magic ATK when using a Basic ATK. If the attack hits a Weak Point, recovers an additional 240% of Magic ATK as HP.',
  },
 ...
 skills: {
  ...
  adaptiveMuscle: {
   ...
   cooldown: 0,
   description:
    'If HP is 50% or higher when attacking, CRIT DMG increases by {44,48,52,56,60,64,68,72,76,80}%. If HP is 20% or lower when hit, all DEF increases by the same amount as your CRIT DMG. This DEF increase scales with missing HP, up to a maximum of 1.3×.',
  },
  bladeStorm: {
   gameKey: 'StormEdge',
  ...
  oathOfPunishmentAndCrushing: {
   ...
   cooldown: 0,
   description:
    "Gain 1 stack of [The Fire Within] whenever an ally is hit. When [The Fire Within] reaches max stacks, automatically respond with the skill 'Pent-Up Wrath.' While under the effect of [Bloodrush], gain 12 AP whenever an ally is hit. - [The Fire Within]: Increases Magic ATK by 3% per stack, up to 4 stacks. Pent-Up Wrath Unleashes your fury to strengthen yourself. Grants [Purification] upon activation. If AP is 200 or less, restore it to 200 and reset the cooldown of Blade Storm. Gain the [Bloodrush] effect for 2 rounds. - [Bloodrush]: Decreases ACC by 10% and Physical DEF by 150, and increases Melee ATK by {71.5,78,84.5,91,97.5,104,110.5,117,123.5,130}%. Reduces Blade Storm’s AP cost by {33,36,39,42,45,48,51,54,57,60}%, and resets its cooldown on use. When [Bloodrush] ends, all stacks of [The Fire Within] are removed.",
  },
 },
