// Griselda Character Data - Horizon Walker
...
const rawGriseldaData = {
  // Basic Character Information
  name: 'Griselda',
  image: 'Griselda', // Character image filename without extension
...
const validation = validateCharacterData(rawGriseldaData);
if (!validation.isValid) {
  throw new Error(`Character data validation failed: ${validation.errors.join(', ')}`);
}

// Export sanitized character data
export const griseldaData = sanitizeCharacterData(rawGriseldaData);
...
export const griseldaHighlighting = sanitizeHighlightPatterns(rawHighlightPatterns);

// SEO metadata
export const griseldaSEO = {
  title: 'Griselda - Horizon Walker Character Guide',
  description:
    'Complete guide for Griselda, an EX rarity Mage character in Horizon Walker. The first and most exalted Arcane Elemental with space manipulation and powerful support abilities.',
  keywords: [
    'Griselda',
    'Horizon Walker',
    'EX rarity',
