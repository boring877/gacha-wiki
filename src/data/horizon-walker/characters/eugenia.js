...
const rawEugeniaData = {
  ...
  weapon: {
    name: "Lumen Veritas",
    flavor: "The Crownseekers, a transmuter order with a history as long as it is formidable, possessed many remarkable relics. Yet none was more renowned beyond their ranks than the Lumen Veritas (Light of Truth) - a sacred artifact said to contain the accumulated power of every Suprema who had ever led them. Upon nearing death, each Suprema would pour the totality of their cultivated strength into the Light of Truth, ensuring the survival of the Crownseekers beyond their own lifetime. In turn, successive Suprema wielded that stored power to stand against the order's enemies. Thus, leadership within the Crownseekers was never a matter of title alone - it was inheritance. However, when the Rift Crisis engulfed Noctis Nebula, the Citadel of Change fell. The Crownseekers themselves were scattered to the brink of dissolution. In the chaos that followed, the Light of Truth vanished. And yet… Considering the immense power sealed within it - and the will of the Suprema that still lingers there - it is difficult to believe its disappearance will remain unresolved for long.",
    type: "Arcane Orb",
    rarity: 'EX',
    image: "Weapon_FullIMG_ArcaneBall_ForEugenia",
    imageOnR2: true,
    maxLevel: 60,
    stats: {
      "Magic ATK (weapon)": "77",
    ...
    uniqueSkills: {
      unique: {
        ...
        type: 'Unique',
        description: "During battle, increases your Max HP by {20,25,30,35,40}%. When using a Support-type skill, you gain {30,35,40,45,50} AP, and all allies except yourself gain {20,24,28,32,36}% increased Crush Boost and Slash Boost for 2R. This AP can only be gained once every 2R.",
      },
      signature: {
        name: "Eugenia Signature: Crownseeker's Might",
        type: 'Signature',
        description: "During battle, increases your Aggro Adjustment by 50 and reduces the AP cost of Energy Form Shift and Flow Overdrive by 15. During battle, increases Crit Rate by an amount equal to 10% of the ATK increase gained from [Soul Resonance], and increases the damage boost effect of [Flow Overdrive] by 50%.",
    ...
    exLevels: {
      effects: [
        { name: "During battle, increases your Max HP", valuesByLevel: "20% / 25% / 30% / 35% / 40%" },
        { name: "When using a Support-type skill, you gain", valuesByLevel: "30 / 35 / 40 / 45 / 50" },
        { name: "AP, and all allies except yourself gain", valuesByLevel: "20% / 24% / 28% / 32% / 36%" },
      ],
    },
  },
  rarityStages: {
