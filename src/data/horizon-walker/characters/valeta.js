...
const rawValetaData = {
 ...
 skills: {
  ...
  darkSacrament: {
   ...
   cooldown: 1,
   description:
    "Can only be activated while possessing 3 or more [Judgment] effects. Grants 3 stacks of [Angel of Judgment]. [Angel of Judgment]: Replaces the “Spinning Slash” skill with “Thornwhip of Condemnation.” At the end of the turn, 1 stack of [Angel of Judgment] is consumed. While [Angel of Judgment] is active, [Judgment] and [Salvation] effects cannot be gained. Thornwhip of Condemnation Strikes enemies with divine power. Deals Slash DMG equal to {90,99,108,117,126,135,144,153,162,171}% of Melee ATK to enemies within a 5m 120° fan-shaped area, and deals additional Immaterial DMG equal to {100,110,120,130,140,150,160,170,180,190}% of Magic ATK for each [Judgment] effect possessed.",
  },
  thornwhipOfCondemnation: {
   ...
   damage: {
    ...
    value: '171% + 190% per [Judgment]',
   },
   description:
    'Strikes enemies with divine power. Deals Slash DMG equal to 171% of melee ATK to enemies within a 5m, 120° fan range, and additional Immaterial DMG equal to 190% of magic ATK for each [Judgment] effect possessed.',
  },
 },
