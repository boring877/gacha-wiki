...
const rawPlatinaData = {
 ...
 skills: {
  ...
  songOfTheSword: {
   ...
   description:
    "Rotates in place, swinging the sword to attack. Deals Slash DMG equal to N% of Melee ATK to all enemies within a 2.5m circular range, enters [Shield Deployment] state, and gains [Gravity Focus] effect. - [Shield Deployment]: Increases Block Chance by 15%, increases Aggro Adjustment, and increases Physical DEF by 150. This skill changes to 'Song of the Shield' while in [Shield Deployment] state. **Song of the Shield** While in [Shield Deployment] state, rotates in place, swinging the sword to deal Slash DMG equal to {90,99,108,117,126,135,144,153,162,171}% of Melee ATK to all targets within 2.5m, and cancels the [Shield Deployment] state. Block Chance is capped at 75%.",
  },
  gravityFall: {
  ...
  heartOfPlatinum: {
   ...
   cooldown: 0,
   description:
    'If not in the [Shield Deployment] state, gain the [Platinum Heart] effect at the start of the turn. When attacked while in [Shield Deployment], gain the [Platinum Aura] effect. [Platinum Heart]: Increases melee attack power by {30,33,36,39,42,45,48,51,54,57}% until the end of the turn. [Platinum Aura]: Reduces AP consumption for the Song of the Shield skill by {15,16.5,18,19.5,21,22.5,24,25.5,27,28.5}%. Stacks up to 8 times. This effect is removed when [Shield Deployment] state ends.',
  },
 },
 rarityStages: {
  'EX': {
