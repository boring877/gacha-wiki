...
const rawPantheriData = {
 ...
 skills: {
  ...
  determination: {
   ...
   cooldown: 0,
   description:
    'When attacked, instead of the basic counterattack (once per round), use the "Sensory Concentration" skill during the counterattack phase. After activation, follow up with a support counterattack. Sensory Concentration Steadies the mind and focuses the senses. Increases Evasion by {200,220,240,260,280,300,320,340,360,380}% for 1R.',
  },
  outlawsMockery: {
  ...
  masterOfSkirmish: {
   ...
   cooldown: 0,
   description:
    "The SwashBuckler's dazzling attacks create a chaotic state where friend and foe are indistinguishable. When attacking during own turn, there is a {50, 55, 60, 65, 70, 75, 80, 85, 90, 100}% chance that the attacked target will mistake their counterattack target. In this case, the enemy will attack their own ally. Additionally, own evasion increases by {100, 110, 120, 130, 140, 150, 160, 170, 180, 190}%, and attacks from behind will not be counted as weakness attacks.",
  },
  thatOneStrike: {
