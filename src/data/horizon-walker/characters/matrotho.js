...
const rawMatrothoData = {
 ...
 skills: {
  ...
  swordOfTheFlowingRiver: {
   ...
   cooldown: 0,
   description:
    "On a successful attack against an enemy with the [Nomination] effect, gains 6 AP and the [Sword of the Flowing River] effect for 1R. Stacks up to 5 times. - [Sword of the Flowing River]: Increases Melee ATK by {30,33,36,39,42,45,48,51,54,57}% while using the 'Sabre Strike' skill.",
  },
  bladeOfWar: {
   gameKey: 'BladeOfWar',
