...
const rawJuzaData = {
 ...
 uniqueTraits: {
  headOnClash: { name: 'Head-On Clash', description: 'Activates the Lv. 1 passive skill [Head-On Clash]. [Head-On Clash]: Reduces Healing Received by 50% and takes Fixed DMG equal to 30% of current HP whenever a skill is used. When attacking, HP cannot fall below 1 until the end of the turn.' },
 ...
 skills: {
  ironClubPunishment: {
   ...
   type: 'Skill',
   description: "Slams the enemy to unleash a shockwave. Deals Crush DMG equal to N% of Melee ATK to the target and all enemies within a 1.5m radius, while dealing Fixed DMG equal to 11% of each ally's Max HP to allies within the area and slightly knocking them back. Also deals additional Crush DMG equal to {110,120,130,140,150,160,170,180,190,200}% per [Fighting Spirit] stack. [Fighting Spirit]: Allows Juza's other skills to take effect on the target. Additional DMG granted by [Fighting Spirit] only applies to enemies.",
  },
  ...
  rampagingComet: {
   ...
   type: 'Skill',
   description: "Gathers nearby objects into a massive sphere and slams it into the target. Deals Crush DMG equal to N% of Melee ATK to enemies within a 5m radius, and Fixed DMG equal to 11% of each ally's Max HP to allies within the area. Deals additional Crush DMG equal to {500,550,600,650,700,750,800,850,900,950}% per [Fighting Spirit] stack. At the end of the turn in which this skill is used, [Crazy Stance] is removed and Juza recovers HP equal to 100% of Max HP. [Fighting Spirit]: Allows Juza's other skills to take effect on the target. Additional DMG granted by [Fighting Spirit] only applies to enemies.",
  },
  indiscriminateBarrage: {
   ...
   type: 'Skill',
   description: "When Juza's HP falls to 30% or lower, performs an additional Response with 'Crazy Stance' and gains [Crazy Stance]. [Crazy Stance]: Loses all Speed, but gains {110,120,130,140,150,160,170,180,190,200}% Crush Boost, {38,41,44,47,50,53,56,59,62,65}% DMG Taken Down, and 2m increased Range. [Crazy Stance] can only activate after Juza's first turn. While [Crazy Stance] is active, 'Iron Club Punishment' is replaced by 'Swift Punishment · Meteor Shower'. While [Crazy Stance] is active, performs an additional Response against a random nearby enemy with 'Swift Punishment · Meteor Shower'. While [Crazy Stance] is active, the Invincibility granted by [Head-On Clash] is extended to 2 turns. Swift Punishment · Meteor Shower This skill is considered a Basic Skill. Deals Crush DMG equal to {150,165,180,195,210,225,240,255,270,285}% of Melee ATK to the target and enemies within a 3.5m-radius circular area around the target, and Fixed DMG equal to 11% of each ally's Max HP to allies within the area, slightly knocking them back. Deals additional Crush DMG equal to {220,240,260,280,300,320,340,360,380,400}% per [Fighting Spirit] stack.",
  },
 },
 rarityStages: {
  'EX': {
