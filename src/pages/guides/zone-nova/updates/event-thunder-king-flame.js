...
export const thunderKingFlameData = {
  ...
  officialUpdate: {
    content: [
      ...
      '',
      'Introduction: This is the deepest secret scene in Yuis\'s heart. The Frozen Heart carries her loneliness and persistence as the God of Judgment. Captains will have the opportunity to glimpse the struggles and emotions deep within her heart.',
      '',
      '4. Guild Trial',
