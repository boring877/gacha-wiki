...
export const afroditeData = {
  ...
  skills: {
    normal: {
      name: 'Love Fist (爱神之拳)',
      description: 'Deals 120% attack power as holy damage to designated enemy unit. Builds toward enhanced ultimate - core mechanic for ultimate enhancement.'
    },
    auto: {
      name: 'Charm Impact (魅惑冲拳)',
      cooldown: '8.0s', // e.g., '5.0s'
      description: 'Automatically deals 816% attack power as holy damage to designated enemy. Increases self attack by 58%. High damage auto skill with substantial self-buffing component.'
    },
    ultimate: {
      name: 'Love and Beauty Waltz (爱与美之圆舞曲)',
      energyCost: '8', // e.g., '5'
      description: 'Normal Ultimate: Deals 1800% attack power as holy damage to designated enemy. Enhanced Ultimate (after 10 normal attacks): Deals 2160% attack power as holy damage to designated enemy, recovers 2 energy at the end, damage converted to normal attack damage. Core mechanic: Build up through normal attacks for maximum damage.'
    },
    passive: {
      name: 'Beautiful Kill (美丽杀意)',
      description: 'When HP > 50%: All attacks deal additional 48% attack power as violent damage. When HP < 50%: Damage taken reduced by 96%. Dual-phase passive that provides offensive power when healthy, defensive power when injured.'
    }
  },
  ...
  teamSkill: {
    ...
    description: 'Self attack power increased by 10%. At battle start: For every 500 attack power, increase self holy damage by 5% (maximum 6 times). Maximum scaling: 30% holy damage boost at 3,000+ attack power.',
    requirements: {
  ...
  awakenings: [
    { level: 1, effect: 'When using skill: Can accumulate 4 times to strengthen the required normal attack count for enhanced ultimate' },
